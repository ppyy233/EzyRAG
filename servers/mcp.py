...
app = FastAPI(title="Ezy-RAG MCP Server", version="0.0.18")
    ...
    if method == "tools/list":
        ...
        return JSONResponse({
            ...
            "result": {
                ...
                "serverInfo": {"name": "Ezy-RAG", "version": "0.0.18"},
                "capabilities": {"tools": {}}
            }
        })
...
def main():
    ...
    logger.info("=" * 50)
    logger.info("Ezy-RAG MCP Server V0.0.18 启动中...")
